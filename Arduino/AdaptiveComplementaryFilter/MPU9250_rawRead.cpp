...
void readIMU(float* ax, float* ay, float* az, float* gx, float* gy, float* gz, float* mx, float* my, float* mz)
{
    ...
    *gx = gyroCount[0]*gRes*180.0/PI;  // get actual gyro value, this depends on scale being set
    *gy = gyroCount[1]*gRes*180.0/PI;  
    *gz = gyroCount[2]*gRes*180.0/PI;   
